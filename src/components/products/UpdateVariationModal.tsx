...
export default function UpdateVariationModal({
  variation,
  onClose,
  onUpdated,
}: {
  ...
  const [size, setSize] =
    useState(variation.size ?? "");

  const [color, setColor] =
    useState(variation.color ?? "");
          ...
          <div className="space-y-4 px-5 py-5">
            ...
            <div>
              ...
              <input
                ...
                value={variation.sku}
                disabled
                className="h-10 w-full rounded-lg border border-zinc-200 bg-zinc-50 px-3 text-sm text-zinc-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="mt-2 flex flex-wrap gap-3">
                ...
                {/* Add image */}
                <label
                  htmlFor="update-variation-images"
